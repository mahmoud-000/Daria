        ...
        <div class="col-12 col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    @lang('setup::setup.database_configuration')
                </div>
                <div class="card-body">

                    <p>@lang('setup::setup.database.intro')</p>

                    @include('setup::partials.alerts')

                    <form action="{{ route('setup.configure-database') }}" method="POST">
                        @csrf

                        <div class="mb-3">
                            <label for="db_host">
                                @lang('setup::setup.database.db_host')
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="db_port">
                                @lang('setup::setup.database.db_port')
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="db_name">
                                @lang('setup::setup.database.db_name')
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="db_user">
                                @lang('setup::setup.database.db_user')
                            </label>
                        ...
                        <div class="mb-3">
                            <label for="db_password">
                                @lang('setup::setup.database.db_password')
                            </label>
                            ...
                            @if($data_present)
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="overwrite_data"
                        ...
                        <button type="submit" class="btn btn-primary">
                            @if($errors->any())
                                @lang('setup::setup.try_again')
                            @else
                                @lang('setup::setup.database_configure')
                            @endif
                        </button>

                        <p class="small text-muted mt-3 mb-0">@lang('setup::setup.database.complete_hint')</p>
