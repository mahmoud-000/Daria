...
class VariantBulkDestroy extends Controller
{
    public function __invoke(Request $request)
    {
        if (!auth()->user()->is_owner)  abort_if(Gate::denies('bulk-delete-variant'), Response::HTTP_FORBIDDEN, __('permission::messages.gate_denies'));
        try {
