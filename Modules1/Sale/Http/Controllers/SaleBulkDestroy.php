...
class SaleBulkDestroy extends Controller
{
    public function __invoke(Request $request)
    {
        if (!auth()->user()->is_owner)  abort_if(Gate::denies('bulk-delete-sale'), Response::HTTP_FORBIDDEN, __('permission::messages.gate_denies'));
        try {
