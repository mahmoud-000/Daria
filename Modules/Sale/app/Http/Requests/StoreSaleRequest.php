...
class StoreSaleRequest extends FormRequest
{
    ...
    {
        return [
            'doc_invoice_number'  => ['sometimes', 'nullable', Rule::unique('sales', 'doc_invoice_number')->withoutTrashed()->ignore($this->sale)],
            ...
            'sale_documents' => ['sometimes', 'array', 'nullable'],
        ];
    }

    public function authorize()
    {
        return auth()->user()->is_owner || Gate::allows('create-sale');
    }
}
