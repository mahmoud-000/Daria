...
class UpdateCompanyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'branches.*.id'       => ['sometimes', 'nullable', 'integer'],
            'branches.*.name'     => ['distinct', 'required', 'string', 'min:3', 'max:100', Rule::unique('branches', 'name')->withoutTrashed()->ignore($this->company->id, 'company_id')],
            ...
            'branches.*.email' => ['distinct', 'sometimes', 'nullable', 'email', Rule::unique('branches', 'email')->withoutTrashed()->ignore($this->company->id, 'company_id')],
