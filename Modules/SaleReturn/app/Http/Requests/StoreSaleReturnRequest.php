...
class StoreSaleReturnRequest extends FormRequest
{
    ...
    {
        return [
            'doc_invoice_number'  => ['sometimes', 'nullable', Rule::unique('saleReturns', 'doc_invoice_number')->withoutTrashed()->ignore($this->saleReturn)],
            ...
            'saleReturn_documents' => ['sometimes', 'array', 'nullable'],
        ];
    }

    public function authorize()
    {
        return auth()->user()->is_owner || Gate::allows('create-saleReturn');
    }
}
