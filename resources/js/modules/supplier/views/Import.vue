...
const fields = reactive({
    username: { required: true, label: t("username") },
    password: { required: false, label: t("password") },
    email: { required: false, label: t("email") },
    firstname: { required: false, label: t("firstname") },
    lastname: { required: false, label: t("lastname") },
    gender: { required: false, label: t("gender") },
    date_of_birth: { required: false, label: t("date_of_birth") },
    date_of_joining: { required: false, label: t("date_of_joining") },
    is_active: { required: false, label: t("is_active") },
});
const store = useStore();
const submit = async () => {
    await store.dispatch(`supplier/importCsv`, mappedCsv.value);
