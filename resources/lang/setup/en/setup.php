...
return [
    ...
    'welcome' => 'Welcome to setup page',
    'intro' => 'In the following steps you will set up Handelify to be ready to use.',
    ...
    'requirements.php_version' => 'PHP version >= 8.2.0',
    ...
    'database.overwrite_data' => 'I confirm that all data should be deleted and overwritten with a new Handelify database',

    'account_setup' => 'Account Setup',
    'account_setup.intro' => 'Before you can start you have to create your user account.',
    'account_setup.username' => 'Enter your username',
    ...
    'outro' => 'You completed the setup and can now use Handelify!',
    'go_to_login' => 'Go to login page',

    'placeholder.username' => 'johndoe',
    'placeholder.email' => 'john.doe@example.com',
    'placeholder.password' => 'Password',
    'placeholder.password_confirmed' => 'Confirmed password',
];
